...
public class DBManager {
    ...
    public Cursor select(){
        String[]colums=new String[]{Constantes.ID,Constantes.NOMBRE,Constantes.CARRERA,Constantes.CURP};
    ...
    public Cursor select(String id){
        ...
        Cursor cursor=database.query(Constantes.TABLA_ALU,colums,whereClause,whereArgs,null,null,null);
        if (cursor!=null){
            cursor.moveToFirst();
        }
        return cursor;
